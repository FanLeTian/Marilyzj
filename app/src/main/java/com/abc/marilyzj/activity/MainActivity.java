...
import com.abc.marilyzj.activity.base.BaseActivity;
import com.abc.marilyzj.fragment.AccountFragment;
import com.abc.marilyzj.fragment.HelpFragment;
import com.abc.marilyzj.fragment.HomeFragment;
...
public class MainActivity extends BaseActivity implements BottomNavigationBar.OnTabSelectedListener{
    ...
    private void initViews() {
        ...
        mBottomNavigationBar.addItem(new BottomNavigationItem(R.drawable.home_normal, "首页").setInactiveIconResource(R.drawable.home_select).setActiveColor("#13B8D1"))
                .addItem(new BottomNavigationItem(R.drawable.accout_normal, "账户").setInactiveIconResource(R.drawable.account_select).setActiveColor("#13B8D1"))
                .addItem(new BottomNavigationItem(R.drawable.set_select, "帮助").setInactiveIconResource(R.drawable.set_noaml).setActiveColor("#13B8D1"))
